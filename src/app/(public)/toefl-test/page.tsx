...
const sections = [
  { 
    ...
    image: "/page images/language tests images/tofel/Prerequisites & Registration.jpeg",
    items: [
  ...
  { 
    ...
    image: "/page images/language tests images/tofel/Available Test Formats.jpeg",
    items: [
  ...
  { 
    ...
    icon: <FaTrophy />, 
    image: "/page images/language tests images/tofel/Achieve Your Target Score.jpeg",
    items: [
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
            ...
            <div className="flex-1 w-full relative group">
              <div className="rounded-2xl md:rounded-3xl overflow-hidden border border-white/5 shadow-2xl relative z-10 transition-all duration-1000">
                <Image 
                  src="/page images/language tests images/tofel/Register & Prepare.jpeg" 
