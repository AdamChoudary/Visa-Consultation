      ...
      <section className="relative w-full h-[calc(100vh-64px)] md:h-[calc(100vh-96px)] overflow-hidden bg-[#0f1921]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
           ...
           >
             ...
             <h1 className="text-6xl md:text-7xl font-black text-white heading-serif leading-[1] tracking-tighter uppercase">
             ...
             <div className="flex flex-wrap items-center justify-center gap-8 pt-10">
               <Link href="/appointments" className="bg-[#d0a850] text-[#0f1921] px-14 py-4 rounded-full font-bold uppercase text-sm tracking-[0.3em] hover:bg-white hover:text-black transition-all no-underline shadow-2xl shadow-[#d0a850]/20">
                 Book Appointment
               </Link>
             </div>
           </motion.div>
