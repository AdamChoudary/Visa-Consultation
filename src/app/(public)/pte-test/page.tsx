        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-5xl mx-auto space-y-10 animate-fade-in">
             <div className="inline-block px-4 py-1 bg-[#d0a850]/10 border border-[#d0a850]/20 rounded-full">
                <span className="text-[#d0a850] text-[10px] font-black uppercase tracking-[0.3em]">Computer-Based Excellence</span>
             </div>
             <h1 className="text-5xl md:text-8xl font-black text-white leading-[0.9] heading-serif uppercase tracking-tighter">
              PTE <br/>
              <span className="text-[#d0a850]">Academic</span>
             </h1>
             <p className="text-xl text-white/70 leading-relaxed font-medium max-w-2xl mx-auto">
               The PTE (Pearson Test of English) is a leading computer-based test trusted by universities and governments worldwide. 
               Fast results in as little as 48 hours.
             </p>
      ...
      <section className="py-32 container mx-auto px-6">
        <div className="max-w-7xl mx-auto bg-white/5 border border-white/10 rounded-[40px] p-10 md:p-20 flex flex-col lg:flex-row items-center gap-20 relative overflow-hidden">
          ...
          <div className="flex-1 space-y-10 relative z-10">
            <h2 className="text-4xl md:text-6xl font-black text-white heading-serif uppercase leading-[1.1] tracking-tight">Fast & <br/> <span className="text-[#d0a850]">Accurate</span></h2>
          ...
          <div className="flex-1 relative group z-10">
             <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
               <img src="/images/pte.jpg" alt="PTE" className="w-full h-auto transition-transform duration-1000 group-hover:scale-105" />
             </div>
          </div>
        </div>
      </section>
