...
export const metadata = buildMetadata({
  path: "/",
  description:
    "The Visa Consultancy — Pakistan's #1 visa consultancy in Islamabad. Expert visa services for student visas, work visas, visit visas, family reunion visas, immigration, and permanent residency (PR) to the UK, USA, Canada, Australia, Schengen, UAE and beyond. Free consultation available.",
  keywords: [
    "visa consultancy",
    "visa consultancy in Islamabad",
    "visa consultancy Pakistan",
    "best visa consultancy in Pakistan",
    "top visa consultancy Islamabad",
